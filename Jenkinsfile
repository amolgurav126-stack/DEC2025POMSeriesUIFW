    ...
    stages 
    {
        ...
        stage('Regression Automation Tests') {
            steps {
                catchError(buildResult: 'SUCCESS', stageResult: 'FAILURE') {
                    git 'https://github.com/amolgurav126-stack/DEC2025POMSeriesUIFW'
        ...
        stage('Sanity Automation Test on PROD') {
            steps {
                catchError(buildResult: 'SUCCESS', stageResult: 'FAILURE') {
                    git 'https://github.com/amolgurav126-stack/DEC2025POMSeriesUIFW'
                    bat "mvn clean test -Dsurefire.suiteXmlFiles=src/test/resources/testrunner/sanity.xml -Denv=prod"
